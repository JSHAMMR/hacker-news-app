...
public class Story: Codable {
    ...
    init(by: String?, descendants: Int?, id: Int?, kids: [Int]?, score: Int?, text: String?, time: Int?, title: String?, type: String?) {
        self.by = by
...
extension Story {
    convenience init(data: Data) throws {
        ...
        self.init(by: me.by, descendants: me.descendants, id: me.id, kids: me.kids, score: me.score, text: me.text, time: me.time, title: me.title, type: me.type)
    }
